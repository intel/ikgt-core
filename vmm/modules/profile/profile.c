...
#define VMCALL_MODULE_PROFILE  0x6C696E01
...
static void trusty_vmcall_dump_profile_data(guest_cpu_handle_t gcpu)
{
	...
	if (gcpu_copy_to_gva(gcpu, dump_gva, (uint64_t)pmod_profile, PROFILE_BUF_SIZE)) {
		ret = 0;
	}
...
void profile_init(void)
{
	...
	vmcall_register(0, VMCALL_MODULE_PROFILE, trusty_vmcall_dump_profile_data);
