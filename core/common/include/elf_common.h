...
#define DT_POSFLAG_1    0x6ffffdfd      /* flags for DT_* entries, effecting the following DT_* entry. See DF_P1_* definitions */
...
#define NT_PROCSTAT_MONAP       10      /* Procstat monap data. */
